...
const DarkModeToggle = () => {
  ...
  return (
    ...
    >
      <div
        className={`absolute top-1 left-1 w-6 h-6 rounded-full transition-all duration-300 transform ${
          isDark ? 'translate-x-8 bg-gray-900' : 'translate-x-0 bg-yellow-400'
